...
export const TOOL_DESCRIPTION = "Search the live web using Exa AI search. Returns high-quality web pages with extracted text highlights.";
export const createExaSearchTool = (config) => Tool.make({
    name: TOOL_NAME,
    label: TOOL_LABEL,
