...
export const ExaSearchParams = Schema.Struct({
    ...
    type: Schema.optional(SearchType.annotate({
        description: "Search type: 'auto' (default, balanced), 'fast' or 'instant' (lower latency), or 'deep' (slower, more thorough).",
    })),
    includeDomains: Schema.optional(Schema.Array(Schema.String).annotate({
        description: "Only include results from these domains (e.g. ['github.com', 'docs.rs']).",
    })),
    excludeDomains: Schema.optional(Schema.Array(Schema.String).annotate({
...
export class ExaSearchFailed extends Schema.TaggedError()("ExaSearchFailed", {
